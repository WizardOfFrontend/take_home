...
// Labels
export const label_PayEquityBy = () => cy.contains('.demographicsTab', 'Pay Equity Gap');
export const label_EmployeesInComparison = () => cy.contains('.demographicsTab', 'Employees in Comparison');
export const label_Budget = () => cy.contains('.demographicsTab', 'Budget');
...
export const errorMsg = () => cy.findByText('Error retrieving requested demographic statistics.')
...
export const checkLabelsAndContents = (option) => {
    // Check the labels
    label_PayEquityBy().should('be.visible');
    label_EmployeesInComparison().should('be.visible');
    label_Budget().should('be.visible');
